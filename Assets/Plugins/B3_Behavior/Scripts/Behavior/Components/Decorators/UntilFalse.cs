...
namespace Quantized.Game.Behavior.Components.Decorators
{
	...
	/// Until false.
	/// </summary>
	public class UntilFalse : BComponent
	{
		#region const
		public static readonly string NAME = "untilFalse";
		#endregion
		...
		public override Window.UnitWindow window 
		{
			get 
			{
				if (_window == null)
				{
					_window = new Window.WinUntilFalse(this);
				}
				return _window;
			}
		}
		...
		{
			return new UntilFalse(parent, behaviorManager, xmlDoc);
		}

		public UntilFalse(BComponent parent, Behaviors behaviorManager, XmlNode xmlDoc)
		{
        ...
        public UntilFalse(UntilFalse unit, BComponent newParent = null)
		{
		...
		{
            return new UntilFalse(this, newParent);
		}
		#endregion
		...
		{
			return string.Format ("[UntilFalse: {0}]", behaviors[0].ToString());
		}
		#endregion
	}
}