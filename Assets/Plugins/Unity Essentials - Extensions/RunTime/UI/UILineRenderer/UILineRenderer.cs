...
namespace UnityEssentials.Extensions.UI.LineRender
{
	[AddComponentMenu("Unity Essentials/UI/UILineRenderer")]
    ...
    public class UILineRenderer : UIPrimitiveBase
	{
		...
		public void SetPoint(int index, Vector2 info)
		{
			m_points[index].x = info.x;
			m_points[index].y = info.y;
			SetAllDirty();
		}
