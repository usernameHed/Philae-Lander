...
namespace UnityEssentials.Extensions
{
    public static class ExtTransform
    {
        ...
        /// </summary>
        public static Transform ClearChilds(this Transform transform, bool immediate = false)
        {
        ...
        public static List<GameObject> GetChildsRoot(this Transform parent)
        {
            List<GameObject> childs = new List<GameObject>(parent.childCount);
        ...
        /// </summary>
        public static List<GameObject> BubbleSortTransforms(this List<int> list, List<GameObject> gameObjects)
        {
