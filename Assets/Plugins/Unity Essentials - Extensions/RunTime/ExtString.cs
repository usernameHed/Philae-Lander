...
namespace UnityEssentials.Extensions
{
    public static class ExtString
    {
        ...
        /// <returns></returns>
        public static string Truncate(this string value, int maxLength, string addAtEnd = "")
        {
            if (string.IsNullOrEmpty(value))
            {
                return (value);
        ...
        public static string ChangeIndex(string sentence, int index, char replaceBy)
        {
            sentence = sentence.Remove(index, 1);
            sentence = sentence.Insert(index, replaceBy.ToString());
            return (sentence);
        }
        ...
        public static bool Contains(this string[] array, string toSearch, out int indexFound)
        {
            indexFound = -1;
