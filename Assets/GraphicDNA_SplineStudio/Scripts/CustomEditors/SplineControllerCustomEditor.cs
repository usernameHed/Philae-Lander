...
public class SplineControllerCustomEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        anyChange |= UITools.Vector3Field(serializedObject, new GUIContent("Rotation Mesh Offset", "Offset applied to the orientation interpolated from the spline"), bb.AdditionalRotationMesh, (obj, value) => { (obj as SplineController).AdditionalRotationMesh = value; });
        anyChange |= UITools.FloatField(serializedObject, new GUIContent("speed rotation", "speed rotation"), bb.speedRotation, (obj, value) => { (obj as SplineController).speedRotation = value; });


            anyChange |= UITools.ObjectField<Transform>(serializedObject, new GUIContent("TargetToLook", "Target transform to look at"), bb.TargetToLook, (obj, value) => { (obj as SplineController).TargetToLook = (Transform)value; });
            anyChange |= UITools.ObjectField<Transform>(serializedObject, new GUIContent("MeshToRotate", "Target transform to look at"), bb.MeshToRotate, (obj, value) => { (obj as SplineController).MeshToRotate = (Transform)value; });
